...
#------------------------------------------------------------------------------#
# (DD/MM/YYYY)
#  2010/10/26 - V1.0  - Ported to IEX and CMV'ed
#  2010/12/08 - V1.0a - Fixed Help Window wouldn't update
#  2011/01/21 - V2.0  - Huge Rehaul!
#                       Added new tab feature, you can now create your own
#                       custom shop tabs
#                       New Graphics options
#  2011/01/21 - V2.0a - Few Visual Fixes, and improvements.
#  2011/01/23 - V2.0b - Fixed to work with KGC_Cursor_Animation
#  2011/01/26 - V2.0c - Fixed sell window issues, prices weren't shown
#                       correctly. Also added a resale rate.
#  2016/01/06 - 2.1.0 - Changed import system to use ScriptDep
#
#------------------------------------------------------------------------------#
#==============================================================================#
# **KNOWN ISSUES
...
#
#------------------------------------------------------------------------------#
$simport.r 'iex/scene_shop_cmv', '2.1.0.alt', 'Cosmetic upgrade for the Shop Scene'
#==============================================================================#
# ** IEX::SCENE_SHOP
#------------------------------------------------------------------------------#
#==============================================================================#
