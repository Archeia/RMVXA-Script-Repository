=begin
===============================================================================
 Custom Collapse Effects V1.5 (25/5/2015)
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
 ...
 of the collapse effect. You can now also set a speed for the battler to sink.
 (27/8/2013)
...
module DataManager
  ...
  # * Load Database
  #--------------------------------------------------------------------------
  class <<self; alias load_database_custom_collapse load_database; end
...
class Sprite_Battler < Sprite_Base
  ...
  def shadowmaster_update_custom_collapse
    ...
    if @sound != nil && @sound_start != nil && @sound_start >= @effect_duration
      sound = RPG::SE.new(@sound, @volume, @pitch)
